...
$(() => {
  ...
  if (horoscope === 'Pisces') {
    $('#horoscopeIcon').attr('src', './images/pisces.jpg');
    ...
    $('#horoscopeIcon').attr('src', './images/Capricorn.jpg');
  };
